...
import { mockStudents, mockCompanies } from '../../constants';
                                    ...
                                    {filteredCompanies.map(c => (
                                        <tr key={c.id}>
                                            ...
                                            <td className="px-6 py-4 text-sm space-x-2 whitespace-nowrap">
                                                ...
                                                <Button as={Link} to={`/admin/users/company/${c.id}`} variant="ghost" size="sm">View Profile</Button>
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
                                    ...
                                    {filteredStudents.map(s => (
                                        <tr key={s.id}>
                                            ...
                                            <td className="px-6 py-4 text-sm space-x-2 whitespace-nowrap">
                                                ...
                                                <Button as={Link} to={`/admin/users/student/${s.id}`} variant="ghost" size="sm">View Profile</Button>
                                             </td>
                                        </tr>
                                    ))}
                                </tbody>
